export default {
  About: {
    Intro:
      "As a full stack developer, I specialize in Java, Python, Typescript, and the React framework. My expertise extends to various AWS tools such as Lambda, Fargate, EC2, DynamoDB, and S3, among others. I have extensive experience building applications on cloud infrastructure using CDK with SDE best practices. ",
    Experience: [
      {
        year: "2019 - present",
